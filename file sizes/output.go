...
// markdownTable is used for generating proper markdown table output.
...
func (t *markdownTable) formatSectionHeader(name string) {
	// Build the full path for section headers
